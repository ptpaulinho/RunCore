...
class Capture:
    ...
    def record_tool(
        ...
        *,
        ...
        # Full result (small, JSON-safe) lets runcore.replay.recorded_tools() serve it back later.
        if os.environ.get("RUNCORE_RECORD_CONTENT", "1") != "0" and len(result_json) <= 64_000:
            metadata.setdefault("result", json.loads(result_json) if result_json else None)
